...
--
-- Name: properties atomic_number_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
...
--
-- Name: TABLE elements; Type: ACL; Schema: public; Owner: freecodecamp
--
...
--
-- Name: TABLE properties; Type: ACL; Schema: public; Owner: freecodecamp
--

GRANT ALL ON TABLE public.properties TO postgres;
...
GRANT ALL ON TABLE public.types TO freecodecamp;
